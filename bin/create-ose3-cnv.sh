...
KUBECTL_URL="https://storage.googleapis.com/kubernetes-release/release/v1.10.3/bin/${ARCH}/amd64/kubectl"
VIRTCTL_URL="https://github.com/kubevirt/kubevirt/releases/download/$VERSION/virtctl-$VERSION-${ARCH}-amd64"
KUBECTL="kubectl"
VIRTCTL="virtctl"
build_status="NULL"
